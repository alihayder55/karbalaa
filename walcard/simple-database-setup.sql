...
-- 1. إنشاء جدول الفئات (بدون is_active)
...
-- 2. إنشاء جدول المنتجات (بدون unit و is_active)
...
-- سياسات للفئات - السماح بالقراءة للجميع
